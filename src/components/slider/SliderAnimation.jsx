      ...
      <div className="container">
        <div className="content">
          <div className="content_inner">
            ...
            >
              <TextLoop>
                <p className="loop-text lead">Педагог</p>
                <p className="loop-text lead"> Наставник</p>
                <p className="loop-text lead"> Мама</p>
              </TextLoop>
              <br /> <span>Работаю в Кызыле.</span>
            </h1>
            <p
              className="text"
              data-aos="fade-up"
              ...
              data-aos-delay="100"
            >
              Профессиональный педагог английского языка
            </p>
            <div
